...
def build_markdown_report(
    ...
    if source == "tvremix":
        ...
        lines.append("")
        intraday_enabled = bool(market_data.get("intraday_enabled", True))
        ohlcv_levels_enabled = bool(market_data.get("ohlcv_levels_enabled", True))
        ...
        if intraday_enabled:
            ...
            if ohlcv_levels_enabled:
                ...
                lines.extend(["- niveles OHLCV omitidos por --skip-ohlcv-levels", ""])
        else:
            lines.extend(["- capa intradía omitida por --skip-intraday", ""])
