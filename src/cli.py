...
from src.audit.scanner_audit import write_scanner_audit
...
def build_parser() -> argparse.ArgumentParser:
    ...
    scan_parser.add_argument("--catalyst-top-n", default=10, type=int, help="Activa catalizadores (>0); en scope=top limita el Top preliminar consultado")
    ...
    scan_parser.add_argument("--external-catalysts", action="store_true", help="Activa capa opcional de catalizadores externos (stub seguro si no hay proveedor)")
    scan_parser.add_argument(
        "--catalyst-scope",
        choices=("universe", "top"),
        default="universe",
        help="Cobertura de noticias/earnings: universo declarado (default) o Top preliminar",
    )
